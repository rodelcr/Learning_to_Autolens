...
| 14 | Compound (Multi-Plane) Lensing | ✓ shipped (2026-05-28) — recursive multi-plane lens equation (S92 eq. 9.7) + N=2 cross-coupling + `tracer_util.py:101-180` source walk; §6 worked forward-model demo: 2-deflector `al.Tracer` (FG SIS z=0.3, main SIE z=0.6, src z=1.5) vs single-plane collapse — headline residual 78% of source peak; per-plane traced grids; tiny 1-param Nautilus fit recovers FG θ_E=0.4501″ (truth 0.45″) in 32 s; executes end-to-end in ~38 s |
