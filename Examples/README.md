...
| 11 | [cluster_scale/](cluster_scale/) | BCG + 10 cluster members + 2 sources at different z | ◐ scaffolded | Architectural union of group_scale (multi-deflector @ same z) + double_source_plane (multi-source @ different z); Faber-Jackson scaling for member galaxies (1 free param shared across all members); multi-source $\beta_{ij}$ cosmography (planned variant) |
